...
public interface JuminService extends IService<JuminEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<JuminEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<JuminEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<JuminEntity> wrapper);
