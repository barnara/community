	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="社区" prop="shequ" >
					<el-input v-model="ruleForm.shequ" placeholder="社区" clearable  :readonly="ro.shequ"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="社区" prop="shequ" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="订单数量" prop="dingdanshuliang" >
					<el-input v-model="ruleForm.dingdanshuliang" placeholder="订单数量" clearable  :readonly="ro.dingdanshuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="订单数量" prop="dingdanshuliang" >
					<el-input v-model="ruleForm.dingdanshuliang" placeholder="订单数量" readonly></el-input>
				</el-form-item>
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `peisongjilu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.peisongjiluCrossAddOrUpdateFlag = false;
											this.parent.search();
