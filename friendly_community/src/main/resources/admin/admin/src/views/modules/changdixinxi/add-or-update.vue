	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="联系热线" prop="lianxirexian" >
					<el-input v-model="ruleForm.lianxirexian" placeholder="联系热线" clearable  :readonly="ro.lianxirexian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="联系热线" prop="lianxirexian" >
					<el-input v-model="ruleForm.lianxirexian" placeholder="联系热线" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'"  label="场地介绍" prop="changdijieshao" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.changdijieshao" 
					class="editor"
					myQuillEditor="changdijieshao"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.changdijieshao" label="场地介绍" prop="changdijieshao" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.changdijieshao"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.changdijieshao = this.ruleForm.changdijieshao.replace(reg,'../../../springboot19ml18s6/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
