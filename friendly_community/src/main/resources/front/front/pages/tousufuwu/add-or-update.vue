	...
	<view :style='{"width":"100%","padding":"40rpx 0 0","position":"relative","background":"#fff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"0 0 48rpx","background":"none","display":"block","height":"auto"}' class="app-update-pv">
			<view :style='{"padding":"4rpx 40rpx","margin":"0 0 8rpx 0","borderColor":"#ccc","alignItems":"center","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"600"}' class="title">标题名称</view>
				<input :style='{"border":"2rpx solid #666","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx","height":"80rpx"}' :disabled="ro.biaotimingcheng" v-model="ruleForm.biaotimingcheng" placeholder="标题名称"  type="text"></input>
			</view>
			<view :style='{"padding":"4rpx 40rpx","margin":"0 0 8rpx 0","borderColor":"#ccc","alignItems":"center","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
			...
			<view :style='{"padding":"4rpx 40rpx","margin":"0 0 8rpx 0","borderColor":"#ccc","alignItems":"center","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class=" select">
				<view :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"600"}' class="title">投诉日期</view>
				<picker  :disabled="ro.tousuriqi" :style='{"width":"100%","flex":"1","height":"auto"}' mode="date" :value="ruleForm.tousuriqi" @change="tousuriqiChange">
					<view :style='{"border":"2rpx solid #666","padding":"0 20rpx","color":"#666","borderRadius":"8rpx","width":"100%","lineHeight":"80rpx","fontSize":"28rpx"}' class="uni-input">{{ruleForm.tousuriqi?ruleForm.tousuriqi:"请选择投诉日期"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"4rpx 40rpx","margin":"0 0 8rpx 0","borderColor":"#ccc","alignItems":"center","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class=" select">
				<view :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"600"}' class="title">投诉状态</view>
				<picker :disabled="ro.tousuzhuangtai" :style='{"width":"100%","flex":"1","height":"auto"}' @change="tousuzhuangtaiChange" :value="tousuzhuangtaiIndex" :range="tousuzhuangtaiOptions">
					<view :style='{"border":"2rpx solid #666","padding":"0 20rpx","color":"#666","borderRadius":"8rpx","width":"100%","lineHeight":"80rpx","fontSize":"28rpx"}' class="uni-input">{{ruleForm.tousuzhuangtai?ruleForm.tousuzhuangtai:"请选择投诉状态"}}</view>
				</picker>
			</view>
			...
			<view :style='{"padding":"4rpx 40rpx","margin":"0 0 8rpx 0","borderColor":"#ccc","alignItems":"center","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx","fontWeight":"600"}' class="title">投诉内容</view>
				<textarea :style='{"border":"2rpx solid #666","padding":"24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx","height":"240rpx"}' v-model="ruleForm.tousuneirong" placeholder="投诉内容" :maxlength="-1"></textarea>
			</view>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			this.ruleForm.tousuriqi = this.$utils.getCurDate();
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`tousufuwu`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='tousuzhuangtai'){
						this.ruleForm.tousuzhuangtai = obj[o];
						this.ro.tousuzhuangtai = true;
						continue;
					}
					if(o=='tupian'){
		...
		methods: {
			...
			tousuzhuangtaiChange(e) {
				this.tousuzhuangtaiIndex = e.target.value
				this.ruleForm.tousuzhuangtai = this.tousuzhuangtaiOptions[this.tousuzhuangtaiIndex]
			},
			...
			async onSubmitTap() {
				...
				//跨表计算判断
				var obj;
				if((!this.ruleForm.biaotimingcheng)){
					this.$utils.msg(`标题名称不能为空`);
					return
				}
				//更新跨表属性
				var crossuserid;
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`tousufuwu`, params);
				...
				//跨表计算
						let oet = {}
						if(this.ruleForm.id){
							await this.$api.update(`tousufuwu`, this.ruleForm);
						}else{
							oet = await this.$api.add(`tousufuwu`, this.ruleForm);
						}
						if(this.cross){
