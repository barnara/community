			...
			<view :style='{"minHeight":"100vh","width":"100%","padding":"0 24rpx 128rpx","position":"relative","background":"#fff","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"calc(100% - 90rpx)","padding":"20rpx 0","background":"none","display":"flex","height":"auto"}'>
					<view :style='{"margin":"0 12rpx","flex":"1","position":"relative"}' class="search-form round">
						...
						<input placeholder-style="color: #333" :style='{"border":"2rpx solid #ccc","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"40rpx","background":"#f5f5f5","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.name" type="text" placeholder="名称" ></input>
					</view>
				...
				<view :style='{"width":"100%","background":"none","height":"auto"}'>
					<view class="uni-product-list" :style='{"padding":"0","margin":"40rpx 0 0","color":"#888","flexWrap":"wrap","display":"flex","width":"100%","fontSize":"26rpx","justifyContent":"space-between","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="uni-product" :style='{"border":"2rpx solid #ccc","padding":"20rpx 10rpx","margin":"0 0 40rpx","backgroundColor":"#fff","flexWrap":"wrap","display":"flex","width":"48%","height":"auto"}' v-for="(product,index) in list" :key="index">
							<view class="uni-product-title " :style='{"padding":"0px 0","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}'>{{product.name}}</view>
							<image :style='{"padding":"0","margin":"0 0 6rpx","objectFit":"cover","display":"block","width":"100%","height":"240rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-if="product.tablename.substr(0,7)=='chapter'" src="/static/chapter.jpg"></image>
							<image :style='{"padding":"0","margin":"0 0 6rpx","objectFit":"cover","display":"block","width":"100%","height":"240rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-else-if="preHttp(product.picture)" :src="product.picture"></image>
							<image :style='{"padding":"0","margin":"0 0 6rpx","objectFit":"cover","display":"block","width":"100%","height":"240rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-else :src="baseUrl+product.picture"></image>
						</view>
					</view>
